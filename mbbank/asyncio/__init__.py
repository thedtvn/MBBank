...
from mbbank.modals.transfer import (
...
class TransferContextAsync(TransferContext):
    ...
    async def verify_transfer(self) -> VerifyTransferResponseModal:
        """
    ...
    async def transfer(self, otp: str, auth_type: AuthListItem):
        """
